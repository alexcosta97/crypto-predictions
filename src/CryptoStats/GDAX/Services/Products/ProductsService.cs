...
using CryptoStats.GDAX.Services.Products.Models.Responses;
...
namespace CryptoStats.GDAX.Services.Products
{
    public class ProductsService: AbstractService
    {
        private readonly IQueryBuilder queryBuilder;

        public ProductsService(IHttpClient httpClient, IHttpRequestMessageService httpRequestMessageService, IQueryBuilder queryBuilder) : base(httpClient, httpRequestMessageService)
        {
