...
\PY{p}{\PYZob{}}
    \PY{k}{public} \PY{k}{interface} \PY{n}{IHttpRequestMessageService}
    \PY{p}{\PYZob{}}
        \PY{n}{HttpRequestMessage} \PY{n+nf}{CreateHttpRequestMessage}\PY{p}{(}
            \PY{n}{HttpMethod} \PY{n}{httpMethod}\PY{p}{,}
            \PY{k+kt}{string} \PY{n}{requestUri}\PY{p}{,}
            \PY{k+kt}{string} \PY{n}{contentBody} \PY{p}{=} \PY{l+s}{\PYZdq{}\PYZdq{}}\PY{p}{)}\PY{p}{;}
    \PY{p}{\PYZcb{}}
\PY{p}{\PYZcb{}}
\end{Verbatim}
