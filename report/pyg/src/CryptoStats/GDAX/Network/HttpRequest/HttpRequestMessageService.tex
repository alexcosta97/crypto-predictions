...
\PY{p}{\PYZob{}}
    \PY{k}{public} \PY{k}{class} \PY{n+nc}{HttpRequestMessageService} \PY{p}{:} \PY{n}{IHttpRequestMessageService}
    \PY{p}{\PYZob{}}
        \PY{k}{private} \PY{k}{readonly} \PY{k+kt}{bool} \PY{n}{sandBox}\PY{p}{;}

        \PY{k}{public} \PY{n+nf}{HttpRequestMessageService}\PY{p}{(}\PY{k+kt}{bool} \PY{n}{sandBox}\PY{p}{)}
        \PY{p}{\PYZob{}}
            \PY{k}{this}\PY{p}{.}\PY{n}{sandBox} \PY{p}{=} \PY{n}{sandBox}\PY{p}{;}
        \PY{p}{\PYZcb{}}

        \PY{k}{public} \PY{n}{HttpRequestMessage} \PY{n+nf}{CreateHttpRequestMessage}\PY{p}{(}\PY{n}{HttpMethod} \PY{n}{httpMethod}\PY{p}{,} \PY{k+kt}{string} \PY{n}{requestUri}\PY{p}{,} \PY{k+kt}{string} \PY{n}{contentBody} \PY{p}{=} \PY{l+s}{\PYZdq{}\PYZdq{}}\PY{p}{)}
        \PY{p}{\PYZob{}}
            \PY{k+kt}{var} \PY{n}{apiUri} \PY{p}{=} \PY{n}{sandBox} \PY{p}{?} \PY{n}{ApiUris}\PY{p}{.}\PY{n}{ApiUriSandbox} \PY{p}{:} \PY{n}{ApiUris}\PY{p}{.}\PY{n}{ApiUri}\PY{p}{;}
            ...
            \PY{p}{\PYZob{}}
                \PY{n}{Content} \PY{p}{=} \PY{n}{contentBody} \PY{p}{=}\PY{p}{=} \PY{k+kt}{string}\PY{p}{.}\PY{n}{Empty} \PY{p}{?} \PY{k}{null} \PY{p}{:} \PY{k}{new} \PY{n}{StringContent}\PY{p}{(}\PY{n}{contentBody}\PY{p}{,} \PY{n}{Encoding}\PY{p}{.}\PY{n}{UTF8}\PY{p}{,} \PY{l+s}{\PYZdq{}application/json\PYZdq{}}\PY{p}{)}
            \PY{p}{\PYZcb{}}\PY{p}{;}
