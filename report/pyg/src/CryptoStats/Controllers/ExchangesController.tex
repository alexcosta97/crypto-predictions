...
\PY{n+na}{    [ApiController]}
    \PY{k}{public} \PY{k}{class} \PY{n+nc}{ExchangesController} \PY{p}{:} \PY{n}{ControllerBase}
    \PY{p}{\PYZob{}}
        \PY{k}{private} \PY{k}{readonly} \PY{n}{CryptoContext} \PY{n}{\PYZus{}context}\PY{p}{;}

        \PY{k}{public} \PY{n+nf}{ExchangesController}\PY{p}{(}\PY{n}{CryptoContext} \PY{n}{context}\PY{p}{)}
        \PY{p}{\PYZob{}}
            \PY{n}{\PYZus{}context} \PY{p}{=} \PY{n}{context}\PY{p}{;}
        \PY{p}{\PYZcb{}}

\PY{n+na}{        [HttpGet]}
        \PY{k}{public} \PY{n}{ActionResult}\PY{p}{\PYZlt{}}\PY{n}{List}\PY{p}{\PYZlt{}}\PY{n}{Exchange}\PY{p}{\PYZgt{}}\PY{p}{\PYZgt{}} \PY{n}{GetAll}\PY{p}{(}\PY{p}{)}
        \PY{p}{\PYZob{}}
            \PY{k}{return} \PY{n}{\PYZus{}context}\PY{p}{.}\PY{n}{Exchanges}\PY{p}{.}\PY{n}{ToList}\PY{p}{(}\PY{p}{)}\PY{p}{;}
        \PY{p}{\PYZcb{}}

\PY{n+na}{        [HttpGet(\PYZdq{}\PYZob{}id\PYZcb{}\PYZdq{}, Name=\PYZdq{}GetExchange\PYZdq{})]}
        \PY{k}{public} \PY{n}{ActionResult}\PY{p}{\PYZlt{}}\PY{n}{Exchange}\PY{p}{\PYZgt{}} \PY{n}{GetById}\PY{p}{(}\PY{k+kt}{int} \PY{n}{id}\PY{p}{)}
        \PY{p}{\PYZob{}}
            \PY{k+kt}{var} \PY{n}{item} \PY{p}{=} \PY{n}{\PYZus{}context}\PY{p}{.}\PY{n}{Exchanges}\PY{p}{.}\PY{n}{Find}\PY{p}{(}\PY{n}{id}\PY{p}{)}\PY{p}{;}
