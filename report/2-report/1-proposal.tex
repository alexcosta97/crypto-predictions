...
\begin{figure}
    ...
    \centering
    \includegraphics[width=\textwidth]{sketches_1.jpg}
\end{figure}
\begin{figure}
    \caption{2nd Sketches}
    \centering
    \includegraphics[width=\textwidth]{sketches_2.jpg}
\end{figure}
...
\begin{figure}
    ...
    \centering
    \includegraphics[width=\textwidth]{homepageBottom.png}
\end{figure}
\begin{figure}
    \caption{About Page}
    \centering
...
\begin{figure}
    ...
    \centering
    \includegraphics[width=\textwidth]{contactUs.png}
\end{figure}
\begin{figure}
    \caption{API Page}
    \centering
